...
<?php
		...
		<div class='alert alert-warning'>
			<span class='glyphicon glyphicon-info-sign'></span> Ada <span style='color:green'>$r</span> barang yang Stok tersisa sudah kurang dari 3 items. silahkan pesan lagi !!
...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header text-white" style="background: rgb(94,66,255);
background: linear-gradient(90deg, rgba(94,66,255,1) 34%, rgba(251,221,166,1) 100%);">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header text-white" style="background: rgb(94,66,255);
background: linear-gradient(90deg, rgba(94,66,255,1) 34%, rgba(251,221,166,1) 100%);">
                <h6 class="pt-2"><i class="fas fa-apple-alt"></i> Stok Barang</h6>
            </div>
            <div class="card-body">
                <center>
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header text-white" style="background: rgb(94,66,255);
background: linear-gradient(90deg, rgba(94,66,255,1) 34%, rgba(251,221,166,1) 100%);">
                <h6 class="pt-2"><i class="fas fa-forward"></i> Telah Terjual</h6>
            </div>
            <div class="card-body">
                <center>
